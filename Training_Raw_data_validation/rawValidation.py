...
class Raw_Data_validation:
    ...
    def valuesFromSchema(self):
        ...
        """
        try:
            if not self.dbObj.isCollectionPresent('mushroomClassifierDB', 'train_schema'):
                with open(self.schema_path, 'r') as f:
                    dic = json.load(f)
                    f.close()
                self.dbObj.insertOneRecord('mushroomClassifierDB', 'train_schema', dic)
            dic = self.dbObj.getRecords('mushroomClassifierDB', 'train_schema')
